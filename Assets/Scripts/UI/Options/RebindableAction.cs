...
public class RebindableAction : MonoBehaviour
{
    ...
    protected void OnEnable()
    {
        if (s_RebindActionUIs == null)
            s_RebindActionUIs = new List<RebindableAction>();
    ...
    private static List<RebindableAction> s_RebindActionUIs;
    ...
    [Serializable]
    public class UpdateBindingUIEvent : UnityEvent<RebindableAction, string, string, string>
    {
    }

    [Serializable]
    public class InteractiveRebindEvent : UnityEvent<RebindableAction, InputActionRebindingExtensions.RebindingOperation>
    {
    }
}
