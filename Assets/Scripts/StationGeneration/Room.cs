...
public class Room : MonoBehaviour
{
    ...
    public int height;
    [Tooltip("The list of potential entraces to the room (assuming from (0,0), from the bottom left.) which corridors will connect to over aiming for the centre of the room." ), Range(0, 20)]
    ...
    public RoomData GenerateRoomData(string dir)
    {
        ...
        roomData.entrances = new List<Vector2Int>();
        ...
        foreach (Tile tile in tiles)
        {
            ...
            if (tile.isEntranceTile)
            {
                roomData.entrances.Add(data.position);
            }
